...
void CutEfficiency1()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5bchan1124.root";
  ...
  sprintf(cut1,"%s && %s && %s && %s && %s",HEDetCut,ComptonManual,ToE_EDependent,tetmCut,chan1124);
  sprintf(cut2,"%s && %s && %s",HEDetCut,ComptonManual,chan1124);
...
void CutEfficiency2()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5bchan1204.root";
...
void CutEfficiency3()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5bchan1174.root";
...
void CutEfficiency4()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5bchan1128.root";
  ...
  sprintf(cut1,"%s && %s && %s && %s && %s",HEDetCut,ComptonManual,ToE_EDependent,tetmCut,chan1128);
  sprintf(cut2,"%s && %s && %s",HEDetCut,ComptonManual,chan1128);
...
void CutEfficiency5()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5bchan1106.root";
...
void CutEfficiency6()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5bchan1176.root";
