...
void CutEfficiency1()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5bchan1172.root";
...
void CutEfficiency2()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5bchan1170.root";
...
void CutEfficiency3()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5bchan1208.root";
  ...
  sprintf(cut1,"%s && %s && %s && %s && %s",HEDetCut,ComptonManual,ToE_EDependent,tetmCut,chan1208);
...
void CutEfficiency4()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5bchan1120.root";
  ...
  sprintf(cut1,"%s && %s && %s && %s && %s",HEDetCut,ComptonManual,ToE_EDependent,tetmCut,chan1120);
  sprintf(cut2,"%s && %s && %s",HEDetCut,ComptonManual,chan1120);
...
void CutEfficiency5()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5bchan1330.root";
...
void CutEfficiency6()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5bchan1332.root";
