...
void CutEfficiency1()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5cchan1124.root";
...
void CutEfficiency2()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5cchan1332.root";
  ...
  sprintf(cut1,"%s && %s && %s && %s && %s",HEDetCut,ComptonManual,ToE_EDependent,tetmCut,chan1332);
  sprintf(cut2,"%s && %s && %s",HEDetCut,ComptonManual,chan1332);
...
void CutEfficiency3()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5cchan614.root";
...
void CutEfficiency4()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5cchan598.root";
...
void CutEfficiency5()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5cchan592.root";
...
void CutEfficiency6()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS5cchan632.root";
