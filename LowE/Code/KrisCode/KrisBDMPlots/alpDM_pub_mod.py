...
if True:
    ...
    #else:
        #legs.append(ROOT.TLegend(0.35, 0.14, 0.55, 0.24))
...
legs[6].AddEntry("lux", "LUX", "")
    ...
    #legs[7].AddEntry("mjdProj0", "  DS1-6 open, 5626 kg-d", "l")
    #legs[7].AddEntry("mjdProj1", "DS1-6 all, 11395 kg-d", "l")
legs[7].AddEntry("pandaxII", "PandaX-II", "")
