  ...
  #include "TMath.h"
  {
    ...
    effSum[i] = (LT*M1*eff1[i]) + (LT*M2*eff2[i]) + (LT*M3*eff3[i]) + (LT*M4*eff4[i]) + (LT*M5*eff5[i]) + (LT*M6*eff6[i]) + (LT*M7*eff7[i]) + (LT*M8*eff8[i]) + (LT*M9*eff9[i]) + (LT*M10*eff10[i]) + (LT*M11*eff11[i]) + (LT*M12*eff12[i]) + (LT*M13*eff13[i]) + (LT*M14*eff14[i]) + (LT*M15*eff15[i]) + (LT*M16*eff16[i]) + (LT*M17*eff17[i]) + (LT*M18*eff18[i]) + (LT*M19*eff19[i])  + (LT*M20*eff20[i])  + (LT*M21*eff21[i]);
    errSumhi[i] = sqrt(((errhi1[i]*M1*LT)*(errhi1[i]*M1*LT)) + ((errM1*eff1[i]*LT)*(errM1*eff1[i]*LT)) + ((errhi2[i]*M2*LT)*(errhi2[i]*M2*LT)) + ((errM2*eff2[i]*LT)*(errM2*eff2[i]*LT)) + ((errhi3[i]*M3*LT)*(errhi3[i]*M3*LT)) + ((errM3*eff3[i]*LT)*(errM3*eff3[i]*LT)) + ((errhi4[i]*M4*LT)*(errhi4[i]*M4*LT)) + ((errM4*eff4[i]*LT)*(errM4*eff4[i]*LT)) + ((errhi5[i]*M5*LT)*(errhi5[i]*M5*LT)) + ((errM5*eff5[i]*LT)*(errM5*eff5[i]*LT)) + ((errhi6[i]*M6*LT)*(errhi6[i]*M6*LT)) + ((errM6*eff6[i]*LT)*(errM6*eff6[i]*LT)) + ((errhi7[i]*M7*LT)*(errhi7[i]*M7*LT)) + ((errM7*eff7[i]*LT)*(errM7*eff7[i]*LT)) + ((errhi8[i]*M8*LT)*(errhi8[i]*M8*LT)) + ((errM8*eff8[i]*LT)*(errM8*eff8[i]*LT)) + ((errhi9[i]*M9*LT)*(errhi9[i]*M9*LT)) + ((errM9*eff9[i]*LT)*(errM9*eff9[i]*LT)) + ((errhi10[i]*M10*LT)*(errhi10[i]*M10*LT)) + ((errM10*eff10[i]*LT)*(errM10*eff10[i]*LT)) + ((errhi11[i]*M11*LT)*(errhi11[i]*M11*LT)) + ((errM11*eff11[i]*LT)*(errM11*eff11[i]*LT)) + ((errhi12[i]*M12*LT)*(errhi12[i]*M12*LT)) + ((errM12*eff12[i]*LT)*(errM12*eff12[i]*LT)) + ((errhi13[i]*M13*LT)*(errhi13[i]*M13*LT)) + ((errM13*eff13[i]*LT)*(errM13*eff13[i]*LT)) + ((errhi14[i]*M14*LT)*(errhi14[i]*M14*LT)) + ((errM14*eff14[i]*LT)*(errM14*eff14[i]*LT)) + ((errhi15[i]*M15*LT)*(errhi15[i]*M5*LT)) + ((errM15*eff15[i]*LT)*(errM15*eff15[i]*LT)) + ((errhi16[i]*M16*LT)*(errhi16[i]*M16*LT)) + ((errM16*eff16[i]*LT)*(errM16*eff16[i]*LT)) + ((errhi17[i]*M17*LT)*(errhi17[i]*M17*LT)) + ((errM17*eff17[i]*LT)*(errM17*eff17[i]*LT)) + ((errhi18[i]*M18*LT)*(errhi18[i]*M18*LT)) + ((errM18*eff18[i]*LT)*(errM18*eff18[i]*LT)) + ((errhi19[i]*M19*LT)*(errhi19[i]*M19*LT)) + ((errM19*eff19[i]*LT)*(errM19*eff19[i]*LT)) + ((errhi20[i]*M20*LT)*(errhi20[i]*M20*LT)) + ((errM20*eff20[i]*LT)*(errM20*eff20[i]*LT)) + ((errhi21[i]*M21*LT)*(errhi21[i]*M21*LT)) + ((errM21*eff21[i]*LT)*(errM21*eff21[i]*LT)));
    errSumlow[i] = sqrt(((errlow1[i]*M1*LT)*(errlow1[i]*M1*LT)) + ((errM1*eff1[i]*LT)*(errM1*eff1[i]*LT)) + ((errlow2[i]*M2*LT)*(errlow2[i]*M2*LT)) + ((errM2*eff2[i]*LT)*(errM2*eff2[i]*LT)) + ((errlow3[i]*M3*LT)*(errlow3[i]*M3*LT)) + ((errM3*eff3[i]*LT)*(errM3*eff3[i]*LT)) + ((errlow4[i]*M4*LT)*(errlow4[i]*M4*LT)) + ((errM4*eff4[i]*LT)*(errM4*eff4[i]*LT)) + ((errlow5[i]*M5*LT)*(errlow5[i]*M5*LT)) + ((errM5*eff5[i]*LT)*(errM5*eff5[i]*LT)) + ((errlow6[i]*M6*LT)*(errlow6[i]*M6*LT)) + ((errM6*eff6[i]*LT)*(errM6*eff6[i]*LT)) + ((errlow7[i]*M7*LT)*(errlow7[i]*M7*LT)) + ((errM7*eff7[i]*LT)*(errM7*eff7[i]*LT)) + ((errlow8[i]*M8*LT)*(errlow8[i]*M8*LT)) + ((errM8*eff8[i]*LT)*(errM8*eff8[i]*LT)) + ((errlow9[i]*M9*LT)*(errlow9[i]*M9*LT)) + ((errM9*eff9[i]*LT)*(errM9*eff9[i]*LT)) + ((errlow10[i]*M10*LT)*(errlow10[i]*M10*LT)) + ((errM10*eff10[i]*LT)*(errM10*eff10[i]*LT)) + ((errlow11[i]*M11*LT)*(errlow11[i]*M11*LT)) + ((errM11*eff11[i]*LT)*(errM11*eff11[i]*LT)) + ((errlow12[i]*M12*LT)*(errlow12[i]*M12*LT)) + ((errM12*eff12[i]*LT)*(errM12*eff12[i]*LT)) + ((errlow13[i]*M13*LT)*(errlow13[i]*M13*LT)) + ((errM13*eff13[i]*LT)*(errM13*eff13[i]*LT)) + ((errlow14[i]*M14*LT)*(errlow14[i]*M14*LT)) + ((errM14*eff14[i]*LT)*(errM14*eff14[i]*LT)) + ((errlow15[i]*M15*LT)*(errlow15[i]*M15*LT)) + ((errM15*eff15[i]*LT)*(errM15*eff15[i]*LT)) + ((errlow16[i]*M16*LT)*(errlow16[i]*M16*LT)) + ((errM16*eff16[i]*LT)*(errM16*eff16[i]*LT)) + ((errlow17[i]*M17*LT)*(errlow17[i]*M17*LT)) + ((errM17*eff17[i]*LT)*(errM17*eff17[i]*LT)) + ((errlow18[i]*M18*LT)*(errlow18[i]*M18*LT)) + ((errM18*eff18[i]*LT)*(errM18*eff18[i]*LT)) + ((errlow19[i]*M19*LT)*(errlow19[i]*M19*LT)) + ((errM19*eff19[i]*LT)*(errM19*eff19[i]*LT)) + ((errlow20[i]*M20*LT)*(errlow20[i]*M20*LT)) + ((errM20*eff20[i]*LT)*(errM20*eff20[i]*LT)) + ((errlow21[i]*M21*LT)*(errlow21[i]*M21*LT)) + ((errM21*eff21[i]*LT)*(errM21*eff21[i]*LT)));
	x[i] = i*5;
    xerr[i] = 0;
    }
