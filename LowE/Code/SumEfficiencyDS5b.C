  ...
  #include "TMath.h"
  {
    ...
    effSum[i] = (LT1*M1*eff1[i]) + (LT2*M2*eff2[i]) + (LT3*M3*eff3[i]) + (LT4*M4*eff4[i]) + (LT5*M5*eff5[i]) + (LT6*M6*eff6[i]) + (LT7*M7*eff7[i]) + (LT8*M8*eff8[i]) + (LT9*M9*eff9[i]) + (LT10*M10*eff10[i]) + (LT11*M11*eff11[i]) + (LT12*M12*eff12[i]) + (LT13*M13*eff13[i]) + (LT14*M14*eff14[i]) + (LT15*M15*eff15[i]) + (LT16*M16*eff16[i]) + (LT17*M17*eff17[i]) + (LT18*M18*eff18[i]) + (LT19*M19*eff19[i]) + (LT20*M20*eff20[i]) + (LT21*M21*eff21[i]) + (LT22*M22*eff22[i]) + (LT23*M23*eff23[i]) + (LT24*M24*eff24[i]) + (LT25*M25*eff25[i]) + (LT26*M26*eff26[i]) + (LT27*M27*eff27[i]) + (LT28*M28*eff28[i]) + (LT29*M29*eff29[i]) + (LT30*M30*eff30[i]) + (LT31*M31*eff31[i]) + (LT32*M32*eff32[i]) + (LT33*M33*eff33[i]) + (LT34*M34*eff34[i]) + (LT35*M35*eff35[i]) + (LT37*M37*eff37[i]) + (LT38*M38*eff38[i]) + (LT39*M39*eff39[i])  ;
    errSumhi[i] = sqrt(((errhi1[i]*M1*LT1)*(errhi1[i]*M1*LT1)) + ((errM1*eff1[i]*LT1)*(errM1*eff1[i]*LT1)) + ((errhi2[i]*M2*LT2)*(errhi2[i]*M2*LT2)) + ((errM2*eff2[i]*LT2)*(errM2*eff2[i]*LT2)) + ((errhi3[i]*M3*LT3)*(errhi3[i]*M3*LT3)) + ((errM3*eff3[i]*LT3)*(errM3*eff3[i]*LT3)) + ((errhi4[i]*M4*LT4)*(errhi4[i]*M4*LT4)) + ((errM4*eff4[i]*LT4)*(errM4*eff4[i]*LT4)) + ((errhi5[i]*M5*LT5)*(errhi5[i]*M5*LT5)) + ((errM5*eff5[i]*LT5)*(errM5*eff5[i]*LT5)) + ((errhi6[i]*M6*LT6)*(errhi6[i]*M6*LT6)) + ((errM6*eff6[i]*LT6)*(errM6*eff6[i]*LT6)) + ((errhi7[i]*M7*LT7)*(errhi7[i]*M7*LT7)) + ((errM7*eff7[i]*LT7)*(errM7*eff7[i]*LT7)) + ((errhi8[i]*M8*LT8)*(errhi8[i]*M8*LT8)) + ((errM8*eff8[i]*LT8)*(errM8*eff8[i]*LT8)) + ((errhi9[i]*M9*LT9)*(errhi9[i]*M9*LT9)) + ((errM9*eff9[i]*LT9)*(errM9*eff9[i]*LT9)) + ((errhi10[i]*M10*LT10)*(errhi10[i]*M10*LT10)) + ((errM10*eff10[i]*LT10)*(errM10*eff10[i]*LT10)) + ((errhi11[i]*M11*LT11)*(errhi11[i]*M11*LT11)) + ((errM11*eff11[i]*LT11)*(errM11*eff11[i]*LT11)) + ((errhi12[i]*M12*LT12)*(errhi12[i]*M12*LT12)) + ((errM12*eff12[i]*LT12)*(errM12*eff12[i]*LT12)) + ((errhi13[i]*M13*LT13)*(errhi13[i]*M13*LT13)) + ((errM13*eff13[i]*LT13)*(errM13*eff13[i]*LT13)) + ((errhi14[i]*M14*LT14)*(errhi14[i]*M14*LT14)) + ((errM14*eff14[i]*LT14)*(errM14*eff14[i]*LT14)) + ((errhi15[i]*M15*LT15)*(errhi15[i]*M5*LT15)) + ((errM15*eff15[i]*LT15)*(errM15*eff15[i]*LT15)) + ((errhi16[i]*M16*LT16)*(errhi16[i]*M16*LT16)) + ((errM16*eff16[i]*LT16)*(errM16*eff16[i]*LT16)) + ((errhi17[i]*M17*LT17)*(errhi17[i]*M17*LT17)) + ((errM17*eff17[i]*LT17)*(errM17*eff17[i]*LT17)) + ((errhi18[i]*M18*LT18)*(errhi18[i]*M18*LT18)) + ((errM18*eff18[i]*LT18)*(errM18*eff18[i]*LT18)) + ((errhi19[i]*M19*LT19)*(errhi19[i]*M19*LT19)) + ((errM19*eff19[i]*LT19)*(errM19*eff19[i]*LT19)) + ((errhi20[i]*M20*LT20)*(errhi20[i]*M20*LT20)) + ((errM20*eff20[i]*LT20)*(errM20*eff20[i]*LT20)) + ((errhi21[i]*M21*LT21)*(errhi21[i]*M21*LT21)) + ((errM21*eff21[i]*LT21)*(errM21*eff21[i]*LT21)) + ((errhi23[i]*M23*LT23)*(errhi23[i]*M23*LT23)) + ((errM23*eff23[i]*LT23)*(errM23*eff23[i]*LT23)) + ((errhi24[i]*M24*LT24)*(errhi24[i]*M24*LT24)) + ((errM24*eff24[i]*LT24)*(errM24*eff24[i]*LT24)) + ((errhi25[i]*M25*LT25)*(errhi25[i]*M25*LT25)) + ((errM25*eff25[i]*LT25)*(errM25*eff25[i]*LT25)) + ((errhi26[i]*M26*LT26)*(errhi26[i]*M26*LT26)) + ((errM26*eff26[i]*LT26)*(errM26*eff26[i]*LT26)) + ((errhi27[i]*M27*LT27)*(errhi27[i]*M27*LT27)) + ((errM27*eff27[i]*LT27)*(errM27*eff27[i]*LT27)) + ((errhi28[i]*M28*LT28)*(errhi28[i]*M28*LT28)) + ((errM28*eff28[i]*LT28)*(errM28*eff28[i]*LT28)) + ((errhi29[i]*M29*LT29)*(errhi29[i]*M29*LT29)) + ((errM29*eff29[i]*LT29)*(errM29*eff29[i]*LT29)) + ((errhi30[i]*M30*LT30)*(errhi30[i]*M30*LT30)) + ((errM30*eff30[i]*LT30)*(errM30*eff30[i]*LT30)) + ((errhi31[i]*M31*LT31)*(errhi31[i]*M31*LT31)) + ((errM31*eff31[i]*LT31)*(errM31*eff31[i]*LT31)) + ((errhi32[i]*M32*LT32)*(errhi32[i]*M32*LT32)) + ((errM32*eff32[i]*LT32)*(errM32*eff32[i]*LT32)) + ((errhi33[i]*M33*LT33)*(errhi33[i]*M33*LT33)) + ((errM33*eff33[i]*LT33)*(errM33*eff33[i]*LT33)) + ((errhi34[i]*M34*LT34)*(errhi34[i]*M34*LT34)) + ((errM34*eff34[i]*LT34)*(errM34*eff34[i]*LT34)) + ((errhi35[i]*M35*LT35)*(errhi35[i]*M35*LT35)) + ((errM35*eff35[i]*LT35)*(errM35*eff35[i]*LT35)) + ((errhi36[i]*M36*LT36)*(errhi36[i]*M36*LT36)) + ((errM36*eff36[i]*LT36)*(errM36*eff36[i]*LT36)) + ((errhi37[i]*M37*LT37)*(errhi37[i]*M37*LT37)) + ((errM37*eff37[i]*LT37)*(errM37*eff37[i]*LT37)) + ((errhi38[i]*M38*LT38)*(errhi38[i]*M38*LT38)) + ((errM38*eff38[i]*LT38)*(errM38*eff38[i]*LT38)) + ((errhi39[i]*M39*LT39)*(errhi39[i]*M39*LT39)) + ((errM39*eff39[i]*LT39)*(errM39*eff39[i]*LT39)));
    errSumlow[i] = sqrt(((errlow1[i]*M1*LT1)*(errlow1[i]*M1*LT1)) + ((errM1*eff1[i]*LT1)*(errM1*eff1[i]*LT1)) + ((errlow2[i]*M2*LT2)*(errlow2[i]*M2*LT2)) + ((errM2*eff2[i]*LT2)*(errM2*eff2[i]*LT2)) + ((errlow3[i]*M3*LT3)*(errlow3[i]*M3*LT3)) + ((errM3*eff3[i]*LT3)*(errM3*eff3[i]*LT3)) + ((errlow4[i]*M4*LT4)*(errlow4[i]*M4*LT4)) + ((errM4*eff4[i]*LT4)*(errM4*eff4[i]*LT4)) + ((errlow5[i]*M5*LT5)*(errlow5[i]*M5*LT5)) + ((errM5*eff5[i]*LT5)*(errM5*eff5[i]*LT5)) + ((errlow6[i]*M6*LT6)*(errlow6[i]*M6*LT6)) + ((errM6*eff6[i]*LT6)*(errM6*eff6[i]*LT6)) + ((errlow7[i]*M7*LT7)*(errlow7[i]*M7*LT7)) + ((errM7*eff7[i]*LT7)*(errM7*eff7[i]*LT7)) + ((errlow8[i]*M8*LT8)*(errlow8[i]*M8*LT8)) + ((errM8*eff8[i]*LT8)*(errM8*eff8[i]*LT8)) + ((errlow9[i]*M9*LT9)*(errlow9[i]*M9*LT9)) + ((errM9*eff9[i]*LT9)*(errM9*eff9[i]*LT9)) + ((errlow10[i]*M10*LT10)*(errlow10[i]*M10*LT10)) + ((errM10*eff10[i]*LT10)*(errM10*eff10[i]*LT10)) + ((errlow11[i]*M11*LT11)*(errlow11[i]*M11*LT11)) + ((errM11*eff11[i]*LT11)*(errM11*eff11[i]*LT11)) + ((errlow12[i]*M12*LT12)*(errlow12[i]*M12*LT12)) + ((errM12*eff12[i]*LT12)*(errM12*eff12[i]*LT12)) + ((errlow13[i]*M13*LT13)*(errlow13[i]*M13*LT13)) + ((errM13*eff13[i]*LT13)*(errM13*eff13[i]*LT13)) + ((errlow14[i]*M14*LT14)*(errlow14[i]*M14*LT14)) + ((errM14*eff14[i]*LT14)*(errM14*eff14[i]*LT14)) + ((errlow15[i]*M15*LT15)*(errlow15[i]*M15*LT15)) + ((errM15*eff15[i]*LT15)*(errM15*eff15[i]*LT15)) + ((errlow16[i]*M16*LT16)*(errlow16[i]*M16*LT16)) + ((errM16*eff16[i]*LT16)*(errM16*eff16[i]*LT16)) + ((errlow17[i]*M17*LT17)*(errlow17[i]*M17*LT17)) + ((errM17*eff17[i]*LT17)*(errM17*eff17[i]*LT17)) + ((errlow18[i]*M18*LT18)*(errlow18[i]*M18*LT18)) + ((errM18*eff18[i]*LT18)*(errM18*eff18[i]*LT18)) + ((errlow19[i]*M19*LT19)*(errlow19[i]*M19*LT19)) + ((errM19*eff19[i]*LT19)*(errM19*eff19[i]*LT19)) + ((errlow20[i]*M20*LT20)*(errlow20[i]*M20*LT20)) + ((errM20*eff20[i]*LT20)*(errM20*eff20[i]*LT20)) + ((errlow21[i]*M21*LT21)*(errlow21[i]*M21*LT21)) + ((errM21*eff21[i]*LT21)*(errM21*eff21[i]*LT21)) + ((errlow22[i]*M22*LT22)*(errlow22[i]*M22*LT22)) + ((errM22*eff22[i]*LT22)*(errM22*eff22[i]*LT22)) + ((errlow23[i]*M23*LT23)*(errlow23[i]*M23*LT23)) + ((errM23*eff23[i]*LT23)*(errM23*eff23[i]*LT23)) + ((errlow24[i]*M24*LT24)*(errlow24[i]*M24*LT24)) + ((errM24*eff24[i]*LT24)*(errM24*eff24[i]*LT24)) + ((errlow25[i]*M25*LT25)*(errlow25[i]*M25*LT25)) + ((errM25*eff25[i]*LT25)*(errM25*eff25[i]*LT25)) + ((errlow26[i]*M26*LT26)*(errlow26[i]*M26*LT26)) + ((errM26*eff26[i]*LT26)*(errM26*eff26[i]*LT26)) + ((errlow27[i]*M27*LT27)*(errlow27[i]*M27*LT27)) + ((errM27*eff27[i]*LT27)*(errM27*eff27[i]*LT27)) + ((errlow28[i]*M28*LT28)*(errlow28[i]*M28*LT28)) + ((errM28*eff28[i]*LT28)*(errM28*eff28[i]*LT28)) + ((errlow29[i]*M29*LT29)*(errlow29[i]*M29*LT29)) + ((errM29*eff29[i]*LT29)*(errM29*eff29[i]*LT29)) + ((errlow30[i]*M30*LT30)*(errlow30[i]*M30*LT30)) + ((errM30*eff30[i]*LT30)*(errM30*eff30[i]*LT30)) + ((errlow31[i]*M13*LT31)*(errlow31[i]*M31*LT31)) + ((errM31*eff31[i]*LT31)*(errM31*eff31[i]*LT31)) + ((errlow32[i]*M32*LT32)*(errlow32[i]*M32*LT32)) + ((errM32*eff32[i]*LT32)*(errM32*eff32[i]*LT32)) + ((errlow33[i]*M33*LT33)*(errlow33[i]*M33*LT33)) + ((errM33*eff33[i]*LT33)*(errM33*eff33[i]*LT33)) + ((errlow34[i]*M34*LT34)*(errlow34[i]*M34*LT34)) + ((errM34*eff34[i]*LT34)*(errM34*eff34[i]*LT34)) + ((errlow35[i]*M35*LT35)*(errlow35[i]*M35*LT35)) + ((errM35*eff35[i]*LT35)*(errM35*eff35[i]*LT35)) + ((errlow36[i]*M36*LT36)*(errlow36[i]*M36*LT36)) + ((errM36*eff36[i]*LT36)*(errM36*eff36[i]*LT36)) + ((errlow37[i]*M37*LT37)*(errlow37[i]*M37*LT37)) + ((errM37*eff37[i]*LT37)*(errM37*eff37[i]*LT37)) + ((errlow38[i]*M38*LT38)*(errlow38[i]*M38*LT38)) + ((errM38*eff38[i]*LT38)*(errM38*eff38[i]*LT38)) + ((errlow39[i]*M39*LT39)*(errlow39[i]*M39*LT39)) + ((errM39*eff39[i]*LT39)*(errM39*eff39[i]*LT39)) );
	x[i] = i*5;
    xerr[i] = 0;
    }
