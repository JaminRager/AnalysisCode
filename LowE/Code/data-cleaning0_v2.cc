...
void TETMvsEnergy()
{
  string outFile = "/global/u1/j/jrager/LowE/TETMvsEnergyDS0.root";
...
void TuneToECut1()
{
  ...
  sprintf(cut3,"%s && %s && %s && %s",basicCut,HEDetCut,EwindowCut3,chanCut1);
...
void TuneToECut2()
{
  ...
  sprintf(cut3,"%s && %s && %s && %s",basicCut,HEDetCut,EwindowCut3,chanCut2);
...
void TuneToECut3()
{
  ...
  sprintf(cut3,"%s && %s && %s && %s",basicCut,HEDetCut,EwindowCut3,chanCut3);
