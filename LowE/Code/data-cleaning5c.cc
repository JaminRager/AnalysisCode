...
char HERunCut[] = "run!=24159 && !(run>=25576 && run<=25580)";
...
void BlindRunSelect()
{
  string outFile = "/global/u1/j/jrager/LowE/BlindRunSelectDS5c_5kThresh.root";
  ...
  TH1F *run = new TH1F("run", "run",  1617, 23975, 25592);
...
void NatToEFinal()
{
  string outFile = "/global/u1/j/jrager/LowE/NatToEDS5cFinal.root";
...
void EnrToEFinal()
{
  string outFile = "/global/u1/j/jrager/LowE/EnrToEDS5cFinal.root";
...
void FinalEnrichedSpectrum()
{
  string outFile = "/global/u1/j/jrager/LowE/AnalysisSpectDS5cNat.root";
  ...
  sprintf(cut1,"%s && %s && %s && %s && %s && %s",basicCut,tetmCut,ToE_EDependent,HEDetCut,HERunCut,natCut);
...
void DetectorSelection()
{
  ...
  //TChain *skimTree = new TChain("skimTree");
  //for (runNumb = 23906; runNumb <= 25505; runNumb++) {
    //char buffer[50];
    //int n;
    //n = sprintf(buffer,"%d",runNumb);
    //dataFile = std::string("/global/projecta/projectdirs/majorana/users/wisecg/cal/skim/skimDS5_run") + buffer + "_low.root";
  ...
  TH2F *detVrun = new TH2F("detVrun", "detVrun", 1617, 23975, 25592, 1440, 0, 1440);
...
void TuneToECut1()
{
  string outFile = "/global/u1/j/jrager/LowE/TuneToECutDS5c_cutTwoChan.root";
...
void TuneToECut2()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/TuneToECutDS5c_twoChan.root";
...
void TuneToECut3()
{
  string outFile = "/global/u1/j/jrager/LowE/TuneToECutDS5c_chan628.root";
