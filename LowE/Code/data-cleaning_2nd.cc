...
char basicCut[] = "gain==0 && mH==1 && isGood && P!=0 && D!=0";
...
void CutEfficiency1()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS6chan608.root";
...
void CutEfficiency2()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS6chan584.root";
  ...
  sprintf(cut1,"%s && %s && %s && %s && %s",HEDetCut,ComptonManual,ToE_EDependent,tetmCut,chan584);
  sprintf(cut2,"%s && %s && %s",HEDetCut,ComptonManual,chan584);
...
void CutEfficiency3()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS6chan624.root";
  ...
  sprintf(cut1,"%s && %s && %s && %s && %s",HEDetCut,ComptonManual,ToE_EDependent,tetmCut,chan624);
...
void CutEfficiency4()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS6chan628.root";
  ...
  sprintf(cut1,"%s && %s && %s && %s && %s",HEDetCut,ComptonManual,ToE_EDependent,tetmCut,chan628);
  sprintf(cut2,"%s && %s && %s",HEDetCut,ComptonManual,chan628);
...
void CutEfficiency5()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS6chan688.root";
  ...
  sprintf(cut1,"%s && %s && %s && %s && %s",HEDetCut,ComptonManual,ToE_EDependent,tetmCut,chan688);
  sprintf(cut2,"%s && %s && %s",HEDetCut,ComptonManual,chan688);
...
void DetectorSelection()
{
  string outFile = "/global/u1/j/jrager/LowE/DetSelectBlindDS6.root";
...
void TuneWFCuts1()
{
    string outFile = "/global/u1/j/jrager/LowE/TuneWFCutsDS6_2chan.root";
    ...
    //sprintf(cut1,"%s && %s && %s && %s",basicCut,HEDetCut,twoChan,tetmCut);
...
void RunSelection()
{
    string outFile = "/global/u1/j/jrager/LowE/RunSelectDS6_5kThresh_ClintFiles.root";
    ...
    TChain *skimTree = new TChain("skimTree");
    //skimTree->Add("/global/projecta/projectdirs/majorana/users/jrager/Skim/V4Skim3-19-18/*.root");
    skimTree->Add("/global/projecta/projectdirs/majorana/users/wisecg/bkg/skim/skimDS6*.root");
    cout << "Adding data files" <<  endl;
