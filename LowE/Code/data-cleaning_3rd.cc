...
void CutEfficiency1()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS6chan694.root";
  ...
  sprintf(cut1,"%s && %s && %s && %s && %s",HEDetCut,ComptonManual,ToE_EDependent,tetmCut,chan694);
  sprintf(cut2,"%s && %s && %s",HEDetCut,ComptonManual,chan694);
...
void CutEfficiency2()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS6chan614.root";
  ...
  sprintf(cut1,"%s && %s && %s && %s && %s",HEDetCut,ComptonManual,ToE_EDependent,tetmCut,chan614);
  sprintf(cut2,"%s && %s && %s",HEDetCut,ComptonManual,chan614);
...
void CutEfficiency3()
{
  string outFile = "/global/u1/j/jrager/LowE/Data/EfficiencyDS6chan598.root";
