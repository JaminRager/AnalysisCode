...
##--------OUTPUT FILE----------
##text_file1 = open("ALP_MJDbinned5_20.txt", "w")
##text_file2 = open("Vec_MJDbinned5_20.txt", "w")
...
##lowEnRange = [x / 5.0 for x in range(int(6.0*5), 20*5+1)] #At low energy, set limit every 0.2 keV (start at 5.6)
lowEnRange = [47.0] #UNCOMMENT ABOVE LINE for 5 - 20 keV
...
##for enVal in xrange(21, 25):
    #try: #python no garbage collecty, so keep doing this until we run out of memory. I know, I know...
        ...
        mean_exp = ROOT.RooRealVar("mean_exp", "Exp Val", 1./4608.2)
