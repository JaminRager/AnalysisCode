...
##--------OUTPUT FILE----------
##text_file1 = open("ALP_Allbinned21_100.txt", "w")
##text_file2 = open("Vec_Allbinned21_100.txt", "w")
...
##for enVal in xrange(21, 25):
    #try: #python no garbage collecty, so keep doing this until we run out of memory. I know, I know...
        ...
        ##peakYield = ROOT.RooFormulaVar("peakYield", "peakYieldInit/eff", peakYieldList)
        ...
        sig10p3 = ROOT.RooRealVar("sig10p3", "Sigma of 10.3 keV peak", sig10p3val, sig10p3val - 0.07, sig10p3val + 0.07)
        ...
        sig47 = ROOT.RooRealVar("sig47", "Sigma of 46.5 keV peak", sig47val, sig47val - 0.07, sig47val + 0.07)
        ...
        sig18p15 = ROOT.RooRealVar("sig18p15", "Sigma of 18.15 keV peak", sig18p15val, sig18p15val - 0.07, sig18p15val + 0.07)
        ...
        sig8p9 = ROOT.RooRealVar("sig8p9", "Sigma of 8.9 keV peak", sig8p9val, sig8p9val - 0.07, sig8p9val + 0.07)
        ...
        sig6p5 = ROOT.RooRealVar("sig6p5", "Sigma of 6.5 keV peak", sig6p5val, sig6p5val - 0.07, sig6p5val + 0.07)
        ...
        #---------5.5 keV Cr51 cosmogenic peak------
        cent5p5 = ROOT.RooRealVar("cent5p5", "True Energy of 5.5 keV peak", 5.5, 5.0, 6.0)
        sig5p5val = GetSigma(5.5)
        sig5p5 = ROOT.RooRealVar("sig5p5", "Sigma of 5.5 keV peak", sig5p5val, sig5p5val - 0.07, sig5p5val + 0.07)
        CrGauss = ROOT.RooGaussian("CrGauss", "Gaussian for 5.5 keV peak", trapENFCal, cent5p5, sig5p5)
        CrGaussYield = ROOT.RooRealVar("CrGaussYield", "Yield of 5.5 keV peak", 100.0, 0.0, 100000.)
        ...
        if enVal <= 20:
                chiSquared = xframe.chiSquare(21)#chiSquare(10)
        else:
                chiSquared = xframe.chiSquare(21)
        ...
        if peakFitVal > 0:
            ...
            limit = p_mu.findRoot(peakYieldInit, 1,50,0.1)  ## 0.1 for the 90% confidence interval
        ...
        print "mean efficiency " + str(mean_eff.getVal())
