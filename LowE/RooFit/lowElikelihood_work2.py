...
def AxioElectric(En): #This function computes the axio-electric cross section
    ...
    if vectorDM:
        ...
        return peVal/.001*3*En*En/(16*CLHEP.pi*1.0/137*511*511)*(1-0.01/3) * 1000 * (72.63 / 75.23)
...
#---------LOAD DATA FROM TREE------
inFileDir = "/Users/krvorren/Project/M1background/output/"
...
tritFile = ROOT.TFile(inFileDir + "../HighTierAnalysis/"+tritFileName)
...
lowEnRange = [43.0] #UNCOMMENT ABOVE LINE for 5 - 20 keV
