...
int main(int argc, char *argv[])
{
  ...
  TH1D *htrapECalP1D1 = new TH1D("trapECalM1", "htrapECalM1", 40, 776., 816.);
  ...
  for(UInt_t eventNum = 1; eventNum < chain->GetEntries(); eventNum++){
	...
	if((*channel)[nHit] == 582) 
	  htrapECalP1D1->Fill((*trapECal)[nHit]);
    else if((*channel)[nHit] == 580)
        htrapECalP1D1->Fill((*trapECal)[nHit]);
    else if((*channel)[nHit] == 578)
        htrapECalP1D1->Fill((*trapECal)[nHit]);
    else if((*channel)[nHit] == 692)
        htrapECalP1D1->Fill((*trapECal)[nHit]);
    else if((*channel)[nHit] == 648)
        htrapECalP1D1->Fill((*trapECal)[nHit]);
    else if((*channel)[nHit] == 640)
        htrapECalP1D1->Fill((*trapECal)[nHit]);
    else if((*channel)[nHit] == 616)
        htrapECalP1D1->Fill((*trapECal)[nHit]);
        ...
        htrapECalP1D1->Fill((*trapECal)[nHit]);    
    else if((*channel)[nHit] == 672)
        htrapECalP1D1->Fill((*trapECal)[nHit]);
    else if((*channel)[nHit] == 632)
        htrapECalP1D1->Fill((*trapECal)[nHit]);
