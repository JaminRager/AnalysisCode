{
  ...
  ch->Add("/global/u1/j/jrager/SpectralAnalysis/Official/spectra/DS1/skim/skimP3KJR*.root");
  ...
  //TH1D* htrapECal = new TH1D("trapECal", "htrapECal", 40, 642, 682);
  //htrapECal -> Fill(trapECal);
  //htrapECal -> Write();
