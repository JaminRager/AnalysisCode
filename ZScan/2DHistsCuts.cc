...
int main(int argc, char *argv[])
{
  ...
  if(argc != 2) {
    ...
    for(UInt_t eventNum = 1; eventNum < chain->GetEntries(); eventNum++){
        ...
        if((*channel)[0]==162 && (*energy)[1]>20900 && (*energy)[1]<21500 && (*energy)[0]>=4000 && (*energy)[0]<=7000){
	    EHists->Fill((*energy)[1],(*energy)[0]);
	    TPHists->Fill((*blrwfFSR50)[1],(*negblrmFSR99)[0]);
        }
        
        else if((*channel)[0]==166 && (*energy)[0]>20900 && (*energy)[0]<21500 && (*energy)[1]>=4000 && (*energy)[1]<=7000){
