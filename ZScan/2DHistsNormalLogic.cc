...
// 2DHists.cc
//
// Creates 2D histogram of events, Ge energy vs NaI energy, as well as
// Ge time point vs NaI time point eAccepts run number as from standard input.
//
//
// J. Rager
// 05/09/16
...
int main(int argc, char *argv[])
{
  ...
  if(argc != 2) {
    ...
    outFileName = savePath + "2Dhists" + std::string(argv[1]) + "take2.root";
