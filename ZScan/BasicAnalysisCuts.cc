...
int main(int argc, char *argv[])
{
  ...
  if(argc != 2) {
    ...
    outFileName = savePath + "dt" + std::string(argv[1]) + "cuts.root";
    ...
    for(UInt_t eventNum = 1; eventNum < chain->GetEntries(); eventNum++){
        ...
        if((*channel)[0]==162 && (*energy)[0]>20900 && (*energy)[0]<21500 && (*energy)[1]>=4000 && (*energy)[1]<=7000){
        ...
        else if((*channel)[0]==166 && (*energy)[1]>20900 && (*energy)[1]<21500 && (*energy)[0]>=4000 && (*energy)[1]<=7000){
