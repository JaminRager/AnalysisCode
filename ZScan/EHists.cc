...
// Attempts to use GATDataSet against better judgement.
//
// J. Rager
// 03/05/16
//
...
int main(int argc, char *argv[])
{
  ...
  if(argc != 2) {
    ...
    outFileName = savePath + "hist" + std::string(argv[1]) + ".root";
    ...
    TH1D *GeHist = new TH1D("GeHist", "GeHist", 10000, 0., 1000000.);
    GeHist->GetXaxis()->SetTitle("energy");
    TH1D *NaIHist = new TH1D("NaIHist", "NaIHist", 10000, 0., 1000000.);
    NaIHist->GetXaxis()->SetTitle("energy");
    //TH1D *GeTP = new TH1D("GeTP", "GeTP", 10000, 0., 1000000.);
    //GeTP->GetXaxis()->SetTitle("time (10's of ns)");
    //TH1D *NaITP = new TH1D("NaITP", "NaITP", 10000, 0., 1000000.);
    //NaITP->GetXaxis()->SetTitle("time (10's of ns)");
    //TH1D *DriftT = new TH1D("DriftT", "DriftT", 10000, 0., 1000000.);
